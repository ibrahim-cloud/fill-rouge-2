...
import AdminDashboardPromoProducts from "../pages/AdminPromoProducts";
import AdminCreatePromoProduct from "../pages/AdminCreatePromoProduct";
...
export {
  ...
  AdminDashboardPromoProducts,
  AdminCreatePromoProduct
};

...
const ProductDetailsCard = ({ setOpen, data }) => {
  ...
  return (
    <div className="">
      {data ? (
        <div className="fixed w-full h-screen rounded-2xl top-0 left-0 bg-[#00000030] z-40 flex items-center justify-center">
          <div className="w-[90%] 800px:w-[60%] h-[90vh] overflow-y-scroll 800px:h-[75vh] bg-[#f0f6ff] rounded-md shadow-sm relative p-4">
            ...
            <div className="block justify-center items-center h-[650PX]  w-full 800px:flex">
              ...
              <div className="flex justify-end">
                  ...
                  <h4 className={`${styles.productDiscountPrice} text-[36px] text-[#F1634C]`}>
                    {data.discountPrice}MAD
                  </h4>
                  <h3 className={`${styles.price} text-[26px] text-[#9c9a9cee]`}>

          ...
          <>
            <div>
              ...
              <div className={`${styles.noramlFlex} p-4`}>
                ...
                <h5 className="pl-2 text-[20px] font-[500]">{cart && cart.length} {t('items')}</h5>
              </div>
            ...
            <div className="px-5 flex border-2 py-2 mb-3">
              <div className=" justify-between w-[90%] text-black font-bold text-[20px]">SubTotal : </div>
              <div className="mt-2 font-bold text-[#F1634C]" >  MAD{totalPrice}
</div>
            </div>
              {/* checkout buttons */}
  ...
  return (
    <div className="border-b p-4">
      <div className="flex">
        ...
        /></div>
        <div className="w-[40%]  font-bold text-[20px] mt-6 text-black">{data.name} <br/>            <h4 className=" text-[15px] text-[#00000082]">

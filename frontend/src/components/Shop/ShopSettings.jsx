...
const ShopSettings = () => {
  ...
  const [accountManager,setAccountManager] = useState(seller && seller.accountManager);
  ...
  const [registryExtract,setRegistryExtract] = useState(seller && seller.registryExtract);
  const [numberICE,setNumberICE] = useState(seller && seller.numberICE);
  const [tva,setTva] = useState(seller && seller.tva);
  const [TitleOfTheAccount,setTitleOfTheAccount] = useState(seller && seller.TitleOfTheAccount);
  const [BankAccountNumber,setBankAccountNumber] = useState(seller && seller.BankAccountNumber);
...
{    name,
  ...
  const handleFileRegistryExtract = async (e) => {
    ...
    await axios.put(`${server}/shop/update-RegistryExtract`, formData,{
      headers: {
          "Content-Type": "multipart/form-data",
      },
      withCredentials: true,
  ...
  const handleFileCompanyId = async (e) => {
    ...
    await axios.put(`${server}/shop/update-fileCompanyId`, formData,{
      headers: {
          "Content-Type": "multipart/form-data",
      },
      withCredentials: true,
...
<div className="w-full ">
              <label className="block text-gray-500 text-xl pb-2">Shop Information</label>
            </div>
      ...
      <div className="flex w-[100%]">
       ...
       <div className="w-[100%] flex items-center flex-col 800px:w-[100%] mt-5">
        ...
        <div className="w-full ">
              <label className="block text-gray-500 text-xl pb-2">Company Information</label>
            </div>
          <div className="flex w-[100%]">
          <div className="w-[100%]">
         ...
         />
          ...
          <div className="w-[100%] flex items-center flex-col 800px:w-[100%] mt-5">
            ...
            {seller.fileCompanyId ? <div> <img className="w-[30%] h-[30%]"
          ...
          <div className="w-[100%] flex items-center flex-col 800px:w-[100%] mt-5">
            <div className="w-full pl-[3%]">
              <label className="block pb-2">registry Extract </label>
                ...
                {seller.registryExtract ? <div> <img className="w-[30%] h-[30%]"
...
: null }
       ...
       <div className="bg-white rounded-lg my-3 w-full p-7">
        <div className="w-full ">
              <label className="block text-gray-500 text-xl pb-2">Bank Information</label>
            </div>
          <div className="flex w-[100%]">
          <div className="w-[100%]">
          <div className="w-[100%] flex items-center flex-col 800px:w-[100%] mt-5">

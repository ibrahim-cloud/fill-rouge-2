    ...
    <div className=" flex flex-wrap ">
     ...
     <div
              ...
              <div className="flex pt-3">
                  <h4 className={`${styles.productDiscountPrice} text-[40px] text-[#F1634C]`}>
                ...
                <h1 className={`${styles.productTitle} mt-6`}>{data.name}</h1>
                <p className="text-[#8a8a8a] mt-3">{data.description}</p>
                <div className="flex  items-center pt-8">
                  ...
                  <div className="pr-8">
                    ...
                    <Link to={`/shop/preview/${data?.shop._id}`}  className=" cursor-pointerrounded-md underline text-[#F1634C] flex items-center"> visite store</Link>
